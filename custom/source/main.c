...
unsigned char dartposition = 0x01;
unsigned char ammoleft = 0x06;
unsigned char score = 0x00;
unsigned char targetposition = 0x01;
...
void dart() {
	...
	switch(dartstate) { //actions
		...
		case dartwait:
			...
			_delay_ms(100);
			//LCD_DisplayString(22, ammoleft + "0");
		...
		case dartend:
			...
			//_delay_ms(300);
			//LCD_DisplayString(21, "OF AMMO! SCORE = ");
			_delay_ms(300);
			LCD_Cursor(38);
