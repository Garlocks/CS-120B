...
enum FStates {FStart, FINIT, UP, DOWN}Fstate;
...
int main(void)
{
	...
	unsigned long Felapsedtime = 0;
	//unsigned long freqtime = 1;
	...
	while(1) {
		...
		Belapsedtime = Belapsedtime + 1;
		Selapsedtime = Selapsedtime + 1;
